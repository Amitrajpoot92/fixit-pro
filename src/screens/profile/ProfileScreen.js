...
export default function ProfileScreen() {
  ...
  const menuItems = [
    ...
    { icon: 'payment', title: 'Payment Methods', color: colors.success, bg: colors.tintGreen, route: 'Payments' },
    // 🚀 NEW: Wallet Option Added Here
      ...
      >
        <View style={styles.userCard}>
          ...
          <View style={styles.userInfo}>
            <Text style={styles.userName}>Aman Developer</Text>
        ...
        <TouchableOpacity style={styles.logoutBtn} onPress={() => console.log('Logout clicked')}>
...
const styles = StyleSheet.create({
  // 🚀 Android Padding Fix for Status Bar (Already applied)
  container: { 
    flex: 1, 
  ...
  avatarPlaceholder: { width: 60, height: 60, borderRadius: 30, backgroundColor: colors.primary, justifyContent: 'center', alignItems: 'center', marginRight: 15 },
